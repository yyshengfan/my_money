...
export class Money {
  ...
  @Column("int", { name: "fund_profit", nullable: true, comment: "fund盈亏" })
  fundProfit: number | null;
  ...
  @Column("int", { name: "sum_profit", nullable: true, comment: "总盈亏" })
